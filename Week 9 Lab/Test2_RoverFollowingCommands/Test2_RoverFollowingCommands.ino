...
float TranslationalPosArray[] = { 0, 20, 20,  40,   40,  60, 60,   80,     80  }; // Put your commands array here
float RotationalAngleArray[]  = { 0,  0, pi/2, pi/2, pi, pi, 1.5*pi, 1.5*pi, 2*pi}; // Put your commands array here
